...
import TrackAdoptionRequests from './Components/TrackAdoptionRequests';
import AdoptionRequestDetails from './Components/AdoptionRequestDetails';
import TrackDaycareBookingRequest from './Components/TrackDaycareBookingRequest';
import TrackVetAppointmentRequest from './Components/TrackVetAppointmentRequest';
import VetAppointmentRequestDetails from './Components/VetAppointmentRequestDetails';
import DaycareBookingRequestDetails from './Components/DaycareBookingRequestDetails';
    ...
    <Router>
      ...
      <div className="app-container">
        <Routes>
          ...
          <Route path="/adopterPanel" element={<AdopterPanel/>} />
          ...
          <Route path="/trackAdoption/:userID" element={<TrackAdoptionRequests/>}/>
          <Route path="/trackDaycareBooking/:userID" element={<TrackDaycareBookingRequest/>}/>
          <Route path="/trackVetAppointment/:userID" element={<TrackVetAppointmentRequest/>}/>
          <Route path="/adoptionRequestDetails/:petID" element={<AdoptionRequestDetails />} />
          <Route path="/appointmentRequestDetails/:appointmentID" element={<VetAppointmentRequestDetails />} />
          <Route path="/bookingRequestDetails/:bookingID" element={<DaycareBookingRequestDetails />} />
