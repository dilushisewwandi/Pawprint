...
import { FaSearch, FaUser, FaDog, FaEnvelope, FaPhone, FaRegStickyNote, FaCalendarAlt, FaIdCard } from 'react-icons/fa';
                                ...
                                <div key={appointment.appointmentID} className="appointment-card">
                                    ...
                                    <div className="request-actions">
                                        <button 
                                            ...
                                            onClick={() => handleApproveRequest(appointment.appointmentID)} 
                                        >
                                            Approve
                                        </button>
                                        <button 
                                            className="reject-button" 
                                            onClick={() => handleRejectRequest(appointment.appointmentID)}  
                                        >
                                            Reject
                                        </button>
                                    </div>
